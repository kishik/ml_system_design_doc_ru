...
- Бизнес-цель - Повышение выручки от продажи билетов и связанных услуг `Product Owner`  
- Почему станет лучше, чем сейчас, от использования ML - Сможем точнее предсказывать спрос на билеты в определнном городе `Product Owner` & `Data Scientist`  
...
- Описание бизнес-процесса пилота, насколько это возможно - как именно мы будем использовать модель в существующем бизнес-процессе? - Продукт будет использован как доп. модуль для основного проекта  RMS `Product Owner`    
...
- Что делаем с технической точки зрения: рекомендательная система, поиск аномалий, прогноз, оптимизация, и др. - Прогноз числа посещений аэропортов на основании данных из новостей `Data Scientist`  
...
Данные о полетах пассажиров в/из определенные города в определенные промежутки времени.
